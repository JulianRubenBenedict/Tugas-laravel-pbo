    ...
    <div class="jumbotron jumbotron-fluid p-3 mb-2 bg-dark text-white rounded-top">
      <div class="container">
        ...
        <div class="text-center">
          <img src="<?php echo e(URL ::to('/assets/foto.jpg')); ?>" class="border border-primary rounded" width="175px">
        </div><br>
        ...
        <tr>
          <td align="center">
            <div class="card p-3 mb-2 bg-dark text-white"  style="width: 18rem;">
              <div class="text-center">
              <img class='gambwar' src="<?php echo e(URL ::to('/assets/instagram.png')); ?>" width="100px">
              </div>
              <div class="card-body">
          ...
          <td align="center">
            <div class="card p-3 mb-2 bg-dark text-white"  style="width: 18rem;">
              <div class="text-center">
              <img align="center" src="<?php echo e(URL ::to('/assets/twitter.png')); ?>" width="100px">
              </div>
              <div class="card-body">
          ...
          <td align="center">
            <div class="card p-3 mb-2 bg-dark text-white"  style="width: 18rem;">
              <div class="text-center">
              <img align="center" src="<?php echo e(URL ::to('/assets/github.png')); ?>" width="100px">
              </div>
              <div class="card-body">
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\MyLaravel\resources\views/profile.blade.php ENDPATH**/ ?>