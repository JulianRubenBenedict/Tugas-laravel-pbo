      ...
      <div class="jumbotron jumbotron-fluid p-3 mb-2 bg-dark text-white rounded-bottom">
        ...
        <table align="center">
          <tr>
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/men.jpeg')}}" class="card-img-top" width="200px">
            ...
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/qwe.jpg')}}" class="card-img-top">
                <div class="card-body p-3 mb-2 bg-light text-dark rounded-bottom">
            ...
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/exp4.png')}}" class="card-img-top">
                <div class="card-body p-3 mb-2 bg-light text-dark rounded-bottom">
          ...
          <tr>
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/exp1.png')}}" class="card-img-top" width="200px">
                <div class="card-body p-3 mb-2 bg-light text-dark rounded-bottom">
            ...
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/exp2.png')}}" class="card-img-top">
                <div class="card-body p-3 mb-2 bg-light text-dark rounded-bottom">
            ...
            <td align="center">
              <div class="card p-3 mb-2 bg-dark text-white" style="width: 18rem;">
                <img src="{{URL ::to('/assets/exp3.png')}}" class="card-img-top">
                <div class="card-body p-3 mb-2 bg-light text-dark rounded-bottom">
